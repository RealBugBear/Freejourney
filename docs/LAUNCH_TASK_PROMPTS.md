...
| T08 | `experience_shares` Baseline-Migration | P1 | Live-Dump nötig (RPC-Definition existiert nur live) | ⛔ 2026-07-07: Session-Permission-Modus verweigert read-only Prod-DB-Queries → in Session mit Standard-Freigaben ausführen (Verfahren exakt wie P0.1-Baseline) |
...
| T23 | Paywall-Grundstruktur bauen (inaktiv hinter `kPaywallEnabled=false`) | P2 (post-launch-Aktivierung, Bau jetzt per D4) | — | 🔄 in Arbeit (2026-07-07) |
