...
| T25 | Multi-Grant/Benefit-Codes + RevenueCat + Apple/Google | P2 | PM-D1–D11-Go; RevenueCat; ASC für T25.3; Play/D-U-N-S für T25.4; AGB vor Aktivierung | ⏸ Masterplan `docs/PAYMENTS_MASTER_PLAN.md`, Build-Prompts `docs/PAYMENTS_BUILD_PROMPTS.md`, Orchestrator `docs/MONETIZATION_STUDIO_MASTER_PROMPT.md`. T25.0 liefert freie Nutzer-/Trainer-/Freunde-/Familien-/Pilot-Grants; T25.1–T25.5 Stores. |
...
| T27 | Trainer Studio: kostenloser MVP → bezahlter Founding-Pilot | Discovery jetzt möglich; Build/pilot gated | Free MVP: P4A + T25.0 + 3–5 Trainer; Paid: Free-MVP-Auswertung + P4B + T25.5 | ⏸ P0 offen. Erster MVP bewusst kostenlos, befristete `pilot`-Grants, keine Auto-Belastung. T27.6A free; T27.6B später Store/paid. Spec/Gates/Prompts/Orchestrator wie T27-Abschnitt. |
